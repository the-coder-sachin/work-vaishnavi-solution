...
const LandingPage = () => {
  return (
    <section>
      <div className="bg relative min-h-screen w-screen overflow-hidden">
        <div className="overplay md:h-screen h-[600px] sm:h-[700px] w-screen bg-amber-400/60 absolute top-0 left-0 -z-10"></div>
        <img
          src={asset.bg}
          alt="bg"
          className="md:h-screen h-[600px] w-screen object-cover -z-20 absolute"
        />
